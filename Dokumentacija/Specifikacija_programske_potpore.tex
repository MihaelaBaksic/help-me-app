	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
					\includegraphics[scale=0.8]{slike/admin.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
					\caption{Admin}
				\end{figure}
				\newpage
			...
			\subsection{Sekvencijski dijagrami}
				...
				\newpage
				\begin{figure}[H]
					\includegraphics[scale=0.65]{slike/pregled-zahtjeva.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
				...
				\newpage
				\begin{figure}[H]
					\includegraphics[scale=0.65]{slike/izvrsavanje-zahtjeva.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
